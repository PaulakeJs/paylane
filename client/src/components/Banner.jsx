  ...
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14">
      <h1 className="text-5xl font-bold text-primary mb-3">
        Find Your Life <span className="text-green-500">Transforming Job</span>
        Today
      </h1>
      <p className="text-lg text-black/70 mb-8">
        Thousands Of Jobs In The Computer, Engineering And Tech Related Fields
        Waiting For You
      </p>
      <form>
          ...
          <div className="flex md:rounded-s-md rounded shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset  focus-within:ring-indigo-600 md:w-1/2 w-full">
            <input
              ...
              className="block flex-1 border-0 bg-transparent py-1.5 pl-8 
                text-gray-900 placeholder:text-gray-400 focus:right-0 sm:text-sm leading-6"
